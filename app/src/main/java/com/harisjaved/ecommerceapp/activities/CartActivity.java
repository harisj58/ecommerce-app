...
import com.harisjaved.ecommerceapp.adapters.MyCartAdapter;
...
public class CartActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LocalBroadcastManager.getInstance(this).registerReceiver(myMessageReceiver, new IntentFilter("MyTotalAmount"));
    ...
    public BroadcastReceiver myMessageReceiver=new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            double amount=(double) overAllTotalAmount;
            Log.i("Amount", ""+amount);
